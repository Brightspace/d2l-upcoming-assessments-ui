 ...
 * @polymerBehavior window.D2L.UpcomingAssessments.LangSvBehavior
 */
window.D2L.UpcomingAssessments.LangSvBehavior = {
	'sv': {
		"activityComplete": "Slutför",
		"activityDueToday": "Förfaller idag",
		"activityEnded": "Stängdes",
		"activityEndsToday": "Slutar idag",
		...
		"dueDateShort": "Förfaller {dueDate}",
		"endDateShort": "Slutar {endDate}",
		"errorMessage": "Ett fel uppstod när widgeten laddades. Vi jobbar på att lösa det så fort som möjligt.",
		"goNextText": "nästa",
