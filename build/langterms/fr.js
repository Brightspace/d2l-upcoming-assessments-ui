 ...
 * @polymerBehavior window.D2L.UpcomingAssessments.LangFrBehavior
 */
window.D2L.UpcomingAssessments.LangFrBehavior = {
	'fr': {
		...
		"content": "Contenu",
		"currentPeriod": "Du {startDate} au {endDate}",
		"discussion": "Discussion",
		"dueDateLongImminent": "{prefix} : {dueDate}",
		"dueDateShort": "Échéance le {dueDate}",
		"endDateShort": "Fin le {endDate}",
...
export default window.D2L.UpcomingAssessments.LangFrBehavior['fr'];
